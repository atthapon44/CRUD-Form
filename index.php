...
<body>
        ...
        <h1 align=center class = "Bgarea">DUD</h1>
        <table class="table">
                <tr>
                    <td><input type="text" class="form-control" id="txtId" placeholder="id "/></td>
                    <td><input type="text" class="form-control" id="txtName" placeholder="Food Name" /></td>
                    <td><input type="text" class="form-control" id="txtPrice" placeholder="cost"/></td>
                    <td>
